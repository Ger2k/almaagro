        ...
        return (
          <Link
            ...
            className={`border-l-4 flex h-[48px] grow items-center justify-center gap-2 rounded-md p-3 text-sm font-medium md:flex-none md:justify-start md:p-2 md:px-3
              ${pathname === hrefWithLocale ? 'border-[#83DCD1] text-[#000000]' : 'bg-transparent text-[#171725]'}
              ${pathname === hrefWithLocale ? 'bg-[linear-gradient(to_right,_rgba(131,_220,_209,_0.15)_80%,_rgba(255,_255,_255,_0.15)_20%)]' : ''}
